...
*/
	...
	//SECURITY
		...
		add_filter('login_errors', 'sp_login_errors_message');
...
function sp_register_assets() {
	...
	if( !is_admin() ) {
		...
		wp_register_style( 'css-reset', SP_ASSETS_THEME . 'css/reset.css', false, SP_THEME_VERSION );
		wp_register_style( 'css-layout', SP_ASSETS_THEME . 'css/layout.css', false, SP_THEME_VERSION );
		wp_register_style( 'responsive', SP_ASSETS_THEME . 'css/responsive.css', false, SP_THEME_VERSION );
...
function sp_login_errors_message(){
...
function sp_custom_login_logo() {
    echo '<style type="text/css">
        ...
        .login h1 a { background-image:url('.SP_ASSETS_THEME.'images/logo.png) !important; width:200px; height:52px; background-size: auto auto !important;}
    </style>';
}
