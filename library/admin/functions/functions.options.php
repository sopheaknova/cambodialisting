...
$of_options[] = array( 	"name" 		=> "Main Custom Logo",
						...
						"id" 		=> "theme_logo",
						"std" 		=> SP_ASSETS_THEME . "assets/images/logo.png",
						"type" 		=> "upload"
				);
...
$of_options[] = array( 	"name" 		=> "Footer Text",
						...
						"id" 		=> "footer_text",
						"std" 		=> "© 2014 Copyright by nova. All rights reserved.",
						"type" 		=> "textarea"
				);
		
//Listing
$of_options[] = array( 	"name" 		=> "Listing",
						"type" 		=> "heading",
						"icon"		=> ADMIN_IMAGES . "icon-docs.png"
				);
				
$of_options[] = array( 	"name" 		=> "Show map",
						"desc" 		=> "Switch ON/OFF listing map",
						"id" 		=> "show_listing_map",
						"std" 		=> 1,
						"type" 		=> "switch"
				);
